...
import Consultas from '../../Services/HorarioProfesor/HorarioProfesorService'

export default class ViewHorarioProfesor extends React.Component {
    state = {
        horario: [], 
        isModal: false,
        formulario: {
    ...
    async componentDidMount() {
        this.getHorarioProfesor();
        

    }
    
    getHorarioProfesor = () => {
        Consultas.getAllHorarioProfesor()
        .then((response) => {
            this.setState({
    ...
    funcionpost = async () => {
        ...
        console.log(this.state.formulario)
        await Consultas.CreateHorarioProfesor(
            this.state.formulario
        )
            .then((response) => {
                this.handleClick();
    ...
    functionput = (id) => {
        Consultas.EditarHorarioProfesor(id, this.state.formulario)
            .then((response) => {
                this.handleClick();
                this.getHorarioProfesor();
            })
    ...
    funcioneliminar = (id) => {
        console.info(id)
        Consultas.EliminarHorarioProfesor(id, this.state.formulario)
            .then((response) => {
                this.getHorarioProfesor();
            })
